...
use dalek::{
    ...
    edwards::{CompressedEdwardsY, EdwardsBasepointTable, EdwardsPoint as DEdwardsPoint},
    ristretto::{CompressedRistretto, RistrettoBasepointTable, RistrettoPoint as DRistrettoPoint},
